...
const FlowBuilderPage = () => {
  ...
  const handleCreateFlow = () => {
    ...
    setNewFlowData({ name: '', description: '', category: 'sales' });
    setShowCreateFlowModal(false);
    
    // Switch to canvas view to start building
    ...
    <div className="h-screen flex bg-gray-900 text-white">
              ...
              <div className="max-w-6xl mx-auto">
                <div className="flex items-center justify-between mb-8">
                  ...
                  <button 
                    ...
                    className="px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 rounded-xl flex items-center space-x-2 font-semibold shadow-lg transform hover:scale-105 transition-all"
                  >
      ...
      {showCreateFlowModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl border border-gray-700 p-8 w-full max-w-md mx-4 shadow-2xl">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-2xl font-bold text-white">Create New Flow</h3>
              <button 
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full p-3 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all resize-none"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setNewFlowData({ ...newFlowData, category: e.target.value })}
                  className="w-full p-3 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
                >
              ...
              <div className="flex space-x-3 pt-4">
                ...
                <button
                  ...
                  disabled={!newFlowData.name.trim()}
                  className="flex-1 py-3 bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 disabled:from-gray-600 disabled:to-gray-600 disabled:cursor-not-allowed rounded-lg font-semibold text-white transition-all shadow-lg"
                >
                  Create Flow
                </button>
              </div>
